...
if __name__ == '__main__': 
    ...
    print(contract_instance.functions.storeMeterReading(str(uuid4()), 100).transact({'from': example_address}))
    print(contract_instance.functions.getMeterReadings().call({'from': example_address}))