...
CONTRACT_COMPILE_FILE_PATH = os.path.join(os.curdir, CONTRACT_TRUFFLE_COMPILE_DIR, COMPILED_CONTRACT_FILE_NAME)
CONTRACT_ADDRESS_FILE_PATH = os.path.join(os.curdir, BLOCKCHAIN_BASE_DIR, COTNRACT_ADDRESS_FILE_NAME)
